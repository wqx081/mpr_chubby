#ifndef BASE_IO_COMPRESSED_OUTPUTBUFFER_H_
#define BASE_IO_COMPRESSED_OUTPUTBUFFER_H_
...
class ZlibOutputBuffer : public WritableFile {
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(ZlibOutputBuffer);
};

}  // namespace io
}  // namespace base

#endif  // BASE_IO_COMPRESSED_OUTPUTBUFFER_H_
