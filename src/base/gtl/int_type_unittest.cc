...
#include "base/gtl/int_type.h"
#include <gtest/gtest.h>

namespace base {

GTL_DEFINE_INT_TYPE(Int8_IT, int8);
GTL_DEFINE_INT_TYPE(UInt8_IT, uint8);
GTL_DEFINE_INT_TYPE(Int16_IT, int16);
GTL_DEFINE_INT_TYPE(UInt16_IT, uint16);
GTL_DEFINE_INT_TYPE(Int32_IT, int32);
GTL_DEFINE_INT_TYPE(Int64_IT, int64);
GTL_DEFINE_INT_TYPE(UInt32_IT, uint32);
GTL_DEFINE_INT_TYPE(UInt64_IT, uint64);
GTL_DEFINE_INT_TYPE(Long_IT, long);  // NOLINT
