...
#ifndef BASE_GTL_INT_TYPE_H_
#define BASE_GTL_INT_TYPE_H_
...
#define GTL_DEFINE_INT_TYPE(int_type_name, value_type)          \
  struct int_type_name##_tag_ {};                                      \
  typedef ::base::gtl::IntType<int_type_name##_tag_, value_type> \
      int_type_name;
