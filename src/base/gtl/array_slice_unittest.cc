...
TEST(MutableIntSlice, IteratorsAndReferences) {
  ...
  auto accept_iterator = [](MutableIntSlice::iterator ) {};
  auto accept_reverse_iterator = [](MutableIntSlice::reverse_iterator ) {};
...
bool TestMutableOverload(MutableIntSlice ) { return false; }

bool TestMutableOverload(MutableCharSlice ) { return true; }
