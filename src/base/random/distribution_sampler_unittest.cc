#include "base/random/distribution_sampler.h"
...
TEST_F(DistributionSamplerTest, KnownDistribution) {
  ...
  TestDistribution(kEven2, ARRAYSIZE(kEven2));
  TestDistribution(kEven3, ARRAYSIZE(kEven3));
  TestDistribution(kEven4, ARRAYSIZE(kEven4));
  TestDistribution(kDist1, ARRAYSIZE(kDist1));
}
